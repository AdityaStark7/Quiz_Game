...
int main()
     {
         ...
         // This Project is made by Ashutosh Bahuguna(2k20/B15/33) and Aditya Kumar(2k20/B15/33)
	...
	printf(" -------------------------------------------------------------------------\n");
 	printf("\t\t*************************************************\n");
	printf("\t\t*         WHO WILL BE A BILLIONAIRE             *\n");
	printf("\t\t*       -----------------------------           *\n");
	printf("\t\t*         Press A to start the game             *\n");
	printf("\t\t*         Press B to view the highest score     *\n");
	printf("\t\t*         Press C to reset score                *\n");
	printf("\t\t*         press D for help                      *\n");
	...
	printf("\t\t*************************************************\n\n\n");
     ...
     printf("\n");
     printf("Ashutosh Bahuguna(2k20/B15/42)");
     printf("\n");
     printf("Aditya Kumar(2k20/B15/33)");
     printf("\n");
   ...
   // scanf("%c" , playername);
    ...
    printf("\n    By this way you can win upto ONE BILLION cash prize!!!!!..........");
    printf("\n >> You will be asked questions continuously, till right answers are given");
    printf("\n\n\t!!!!!!!!!!!!! BOOOOOOOOOOOOOOOOOOOO YAAAAAAAAAHHHHHHHHHHHH !!!!!!!!!!!!!");
    ...
    system("cls");
     ...
     switch(r1)
		...
		printf("\n\nA.california\t\tB.israel\n\nC.Santiago\t\tD.Valparaiso");
		if (toupper(getch())=='C')
			{
			    printf("\n\nCorrect!!!");
			    count++;
		       ...
		       {
		           printf("\n\nWrong!!! The correct answer is C.Santiago");
		           getch();
		       break;
		       }
		...
		if (toupper(getch())=='C')
			...
			break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is C.E");
		       getch();
		       break;}
...
void help()
	...
	printf("\n\n\t*********************BEST OF LUCK*********************************");
	printf("\n\n\t*****ADITYA KUMAR & ASHUTOSH BAHUGUNA*****************************");
	}
